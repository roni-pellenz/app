...
export function IncomeRow({ income, onPress, onToggleReceipt, onDelete }: IncomeRowProps) {
  ...
  const onToggleReceiptRef = useRef(onToggleReceipt);
  ...
  const receiptBackgroundOpacity = translateX.interpolate({
    inputRange: [-1, 0, 1],
    outputRange: [0, 0, 1],
    extrapolate: "clamp"
  });
    ...
    >
      <Animated.View
        ...
        style={[
          ...
          styles.receiptBackground,
          {
            opacity: receiptBackgroundOpacity
          }
        ]}
      />
      ...
      >
        ...
        >
          <View
            style={[styles.iconContainer, recurring ? styles.recurringIcon : styles.oneOffIcon]}
          >
            <Ionicons
          ...
          <View style={styles.content}>
            <View style={styles.textContent}>
              ...
              <Text style={styles.meta}>
                Competência: {formatShortCompetence(income.competence)}
              </Text>
            </View>

            <View style={styles.rightContent}>
              <Text
                style={[styles.amount, isReceived && styles.receivedAmount]}
                numberOfLines={1}
